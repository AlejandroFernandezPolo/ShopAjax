...
<div class="col-lg-12">
    <div class="row gy-3">
        <form action="{{ url('product/' . $product->id) }}" method="post">
            @method('put')
            @csrf
            <h3 class="mb-12 billing-heading">Edit Product</h3>


            <!-- Campo 1: Name -->
            <div class="col-lg-12">
                <label class="form-label text-sm text-uppercase" for="name">Name</label>
                <input class="form-control form-control-lg" type="text" id="nameProduct" placeholder="Name" name="name" value="{{ old('name', $product->name) }}">
            </div>
            ...
            <div class="col-lg-6">
                ...
                <input class="form-control form-control-lg" type="number" id="priceProduct" placeholder="1.0"
                    step="0.01" min="0" max="100000000"  name="price" value="{{ old('price', $product->price) }}">
            </div>
            ...
            <div class="col-lg-6">
                ...
                <input class="form-control form-control-lg" type="text" id="descriptionProduct"
                    placeholder="Description" name="description" value="{{ old('description', $product->description) }}">
            </div>

            <!-- Campo 5: Thumbnail -->
            <div class="col-lg-6">
                <label class="form-label text-sm text-uppercase" for="file">Thumbnail</label>
                <input class="form-control form-control-lg" type="file" id="file" name="file" value="{{ old('file', $product->file) }}">
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row gy-3" id="specifications-container">
                    @foreach (json_decode($product->specifications) as $name => $specification)
                        <div class="col-lg-6">
                            <input class="form-control form-control-lg" type="text" placeholder="Name" name="spec_name[]" value="{{ $name }}">
                        </div>
                        <div class="col-lg-6">
                            <input class="form-control form-control-lg" type="text" placeholder="Data" name="spec_data[]" value="{{ $specification }}">
                        </div>
                    @endforeach
                    <!-- Especificación 1 -->
